 ...
 */
public class DeleteAuthorAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        } catch (NumberFormatException e)
        {
            ...
            throw new NumberFormatException("ERROR: None int value passed as AuthorID");
        }
        
        AuthorBusinessLogic.delete(authorId);
